...
var Fetch = /** @class */function () {
  function Fetch(serviceRef, options, subscribe, initState) {
    ...
    this.state = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, this.state), {
  ...
  Fetch.prototype.setState = function (s) {
    ...
    this.state = tslib_1.__assign(tslib_1.__assign({}, this.state), s);
    this.subscribe();
  };
  Fetch.prototype.runPluginHandler = function (event) {
    ...
    var r = this.pluginImpls.map(function (i) {
      var _a;
      return (_a = i[event]) === null || _a === void 0 ? void 0 : _a.call.apply(_a, tslib_1.__spreadArray([i], tslib_1.__read(rest), false));
    }).filter(Boolean);
    return Object.assign.apply(Object, tslib_1.__spreadArray([{}], tslib_1.__read(r), false));
  };
      ...
      return tslib_1.__generator(this, function (_q) {
        switch (_q.label) {
          case 0:
            ...
            _l = this.runPluginHandler('onBefore', params), _m = _l.stopNow, stopNow = _m === void 0 ? false : _m, _o = _l.returnNow, returnNow = _o === void 0 ? false : _o, state = tslib_1.__rest(_l, ["stopNow", "returnNow"]);
            // stop request
            if (stopNow) {
              return [2 /*return*/, new Promise(function () {})];
            }
            this.setState(tslib_1.__assign({
              loading: true,
              params: params
            }, state));
            // return now
          ...
          case 1:
            ...
            if (!servicePromise) {
              servicePromise = (_p = this.serviceRef).current.apply(_p, tslib_1.__spreadArray([], tslib_1.__read(params), false));
            }
  ...
  Fetch.prototype.run = function () {
    ...
    this.runAsync.apply(this, tslib_1.__spreadArray([], tslib_1.__read(params), false))["catch"](function (error) {
  ...
  Fetch.prototype.refresh = function () {
    // @ts-ignore
    this.run.apply(this, tslib_1.__spreadArray([], tslib_1.__read(this.state.params || []), false));
  };
  Fetch.prototype.refreshAsync = function () {
    // @ts-ignore
    return this.runAsync.apply(this, tslib_1.__spreadArray([], tslib_1.__read(this.state.params || []), false));
  };
  Fetch.prototype.mutate = function (data) {
    var targetData = (0, isFunction_1["default"])(data) ? data(this.state.data) : data;
